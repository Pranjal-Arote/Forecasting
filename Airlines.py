# -*- coding: utf-8 -*-
"""
Created on Thu Mar 14 22:12:57 2024

@author: Pranjal Arote
"""
'''
1.	The dataset consists of monthly totals of international 
airline passengers from 1995 to 2002. Our main aim is to 
predict the number of passengers for the next five years 
using time series forecasting. Prepare a document for each 
model explaining how many dummy variables you have created 
and also include the RMSE value for each model.
'''
import pandas as pd
import numpy as np
...
data=pd.read_csv("C:/DataSet/Airlines Data.csv")
data.shape
...
# Assuming data_log is your DataFrame with a non-DateTimeIndex index
# Convert the index to DateTimeIndex
print(data["Month"].iloc[60])
data_log.index = pd.to_datetime(data_log.index)

# Assuming the frequency is not set
# Set the frequency if necessary
# For example, if your data is monthly, you would do:
# data_log.index.freq = 'M'
